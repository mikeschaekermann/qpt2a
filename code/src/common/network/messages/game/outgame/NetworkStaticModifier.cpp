...
NetworkStaticModifier::NetworkStaticModifier() : type(StaticModifierType::Invalid)
{
}

NetworkStaticModifier::NetworkStaticModifier(char* data, unsigned &index) : type(StaticModifierType::Invalid)
{
	...
	type = StaticModifierType(networkType);
	index += sizeof(networkType);
}

NetworkStaticModifier::~NetworkStaticModifier() 
{ 
}

unsigned NetworkStaticModifier::writeToArray(char* data, unsigned start)
{
...
unsigned NetworkStaticModifier::calculateSize()
{
